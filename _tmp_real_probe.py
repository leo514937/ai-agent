...
cases.append(('3', run_agent_graph('便宜一点的呢', 'real_q3')))

reset_session_store()
store = get_session_store()
store.save('real_q4', SessionState(last_recommendation_list=[SHOP_HAIDILAO, SHOP_KAOROU]))
cases.append(('4', run_agent_graph('第一家有券吗', 'real_q4')))
...
for idx, resp in cases:
    ...
    print(idx, json.dumps({
        ...
        'reference_resolution_source': sf.get('reference_resolution_source'),
