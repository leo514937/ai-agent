        ...
        trace.extra = {
            **dict(trace.extra),
            ...
            "retrieval_counts": {
                ...
                "semantic": len(pack.semantic_memories),
                "episodic": len(pack.episodic_memories),
                "procedural": len(pack.procedural_memories),
        ...
        client_context.update(
            {
                ...
                "memory_semantic_count": len(injection.semantic_memories),
                "memory_episodic_count": len(injection.episodic_memories),
                "memory_procedural_count": len(injection.procedural_memories),
        ...
        trace.extra = {
            **dict(trace.extra),
            ...
            "memory_counts": {
                ...
                "semantic": len(injection.semantic_memories),
                "episodic": len(injection.episodic_memories),
                "procedural": len(injection.procedural_memories),
