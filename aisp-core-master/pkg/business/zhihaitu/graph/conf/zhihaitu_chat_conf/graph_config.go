...
const (
	...
	QuestionReportLogic                  = "questionReport"
	QuestionRecordLogic                  = "questionRecord"
	AnswerRecordLogic                    = "answerRecord"
	...
	AnswerSecurityReviewConditionLogic   = "answerSecurityReviewCondition"
	Empty1Logic                          = "empty1"
	AnswerRecordUpdateLogic              = "answerRecordUpdate"
	AnswerReportLogic                    = "answerReport"
	ResponseLogic                        = macro.ResponseNode
)

var LogicBizConfigMap = map[string]map[string]string{
	QuestionReportLogic: {
		conf.ConfigMessageType: string(conf.MessageTypeQuestion),
	},
	QuestionRecordLogic: {
		conf.ConfigMessageType: string(conf.MessageTypeQuestion),
	},
	AnswerRecordLogic: {
		conf.ConfigMessageType: string(conf.MessageTypeAnswer),
	},
	RedLineLogic: {
		conf.ConfigAllowExempt: "false",
	},
	...
	AnswerSecurityReviewConditionLogic: {
		conf.ConditionCondition:  "==",
		conf.ConditionCompareTo:  "true",
		conf.ConditionIfBranch:   entities.Normal,
		conf.ConditionElseBranch: entities.Break,
	},
	AnswerRecordUpdateLogic: {
		conf.ConfigMessageType: string(conf.MessageTypeAnswer),
	},
	ResponseLogic: {
...
var LogicStaticConfigMap = map[string]map[string]string{
	QuestionReportLogic: {
		conf.ConfigInputNames: util.JoinNamesToString(
			graph_macro.ZagKeyMemberId, graph_macro.ZagKeySessionId,
			graph_macro.ZagKeyQueryMessageId, graph_macro.ZagKeyQueryText,
		),
	},
	QuestionRecordLogic: {
		conf.ConfigInputNames: util.JoinNamesToString(
			graph_macro.ZagKeySessionId, graph_macro.ZagKeyMemberId, graph_macro.ZagKeyQueryMessageId,
			graph_macro.ZagKeyQueryParentMessageId, graph_macro.ZagKeyQueryText,
		),
	},
	AnswerRecordLogic: {
		conf.ConfigInputNames: util.JoinNamesToString(
			graph_macro.ZagKeySessionId, graph_macro.ZagKeyMemberId, graph_macro.ZagKeyRespMessageId,
			graph_macro.ZagKeyQueryMessageId,
		),
	},
	RedLineLogic: {
	...
	AnswerSecurityReviewConditionLogic: {
		conf.ConfigInputNames: graph_macro.ZagKeyAnswerSecurityReviewIsAvailable,
	},
	AnswerRecordUpdateLogic: {
		conf.ConfigInputNames: util.JoinNamesToString(
			graph_macro.ZagKeyAnswerSecurityReviewIsAvailable,
			graph_macro.ZagKeyRedLineAnswer,
			graph_macro.ZagKeyChatRespMessage,
			graph_macro.ZagKeyRespMessageId,
			graph_macro.ZagKeyFaqAnswer,
		),
	},
	AnswerReportLogic: {
		conf.ConfigInputNames: util.JoinNamesToString(
			graph_macro.ZagKeySessionId, graph_macro.ZagKeyQueryMessageId,
			graph_macro.ZagKeyRespMessageId, graph_macro.ZagKeyChatRespMessage,
			graph_macro.ZagKeyMemberId, graph_macro.ZagKeyRedLineAnswer,
			graph_macro.ZagKeyAnswerSecurityReviewIsAvailable, graph_macro.ZagKeyFaqAnswer,
		),
	},
	ResponseLogic: {
		conf.ConfigInputNames: util.JoinNamesToString(
			graph_macro.ZagKeyQuerySecurityReviewIsAvailable, graph_macro.ZagKeyRedLineAnswer, graph_macro.ZagKeyRespMessageId),
