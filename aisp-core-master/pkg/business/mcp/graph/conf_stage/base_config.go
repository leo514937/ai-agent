...
func init() {
	stage_handler.RegisterStageLogicConfig(&ChatZhiDaMCPLogicConfig{
...
type ChatZhiDaMCPLogicConfig struct {
...
func (c *ChatZhiDaMCPLogicConfig) GetGraphBizType() string {
	return stage_handler.GraphLogicConfigNameByZhiDaMCP
}

// GetRecallGraphBizType 获取召回图名称
func (c *ChatZhiDaMCPLogicConfig) GetRecallGraphBizType() string {
	return ""
}

// GetDeepSearchGraphBizType 获取深度搜索图名称
func (c *ChatZhiDaMCPLogicConfig) GetDeepSearchGraphBizType() string {
	return ""
}

// GetDefaultBizConfigMap 获取默认配置
func (c *ChatZhiDaMCPLogicConfig) GetDefaultBizConfigMap() map[string]map[string]string {
...
func (c *ChatZhiDaMCPLogicConfig) GetDynamicBizLogicConfig(
	ctx context.Context,
...
func (c *ChatZhiDaMCPLogicConfig) GetAbParamMap() map[zlab.SceneId][]zlab.ZlabValue {
