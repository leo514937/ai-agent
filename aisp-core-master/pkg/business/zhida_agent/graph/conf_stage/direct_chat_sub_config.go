...
type DirectChatSubLogicConfig struct {
...
func (c *DirectChatSubLogicConfig) GetGraphBizType() string {
	return stage_handler.GraphLogicConfigNameByDirectChatSub
}

// GetRecallGraphBizType 获取召回图名称
func (c *DirectChatSubLogicConfig) GetRecallGraphBizType() string {
	return ""
}

// GetDeepSearchGraphBizType 获取深度搜索图名称
func (c *DirectChatSubLogicConfig) GetDeepSearchGraphBizType() string {
	return ""
}

// GetDefaultBizConfigMap 获取默认配置
func (c *DirectChatSubLogicConfig) GetDefaultBizConfigMap() map[string]map[string]string {
...
func (c *DirectChatSubLogicConfig) GetDynamicBizLogicConfig(
	ctx context.Context,
...
func (c *DirectChatSubLogicConfig) GetAbParamMap() map[zlab.SceneId][]zlab.ZlabValue {
