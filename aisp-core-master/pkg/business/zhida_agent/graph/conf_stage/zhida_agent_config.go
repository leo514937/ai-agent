...
type ZhiDaAgentLogicConfig struct {
...
func (c *ZhiDaAgentLogicConfig) GetGraphBizType() string {
	return stage_handler.GraphLogicConfigNameByZhiDaAgent
}

// GetRecallGraphBizType 获取召回图名称
func (c *ZhiDaAgentLogicConfig) GetRecallGraphBizType() string {
	return ""
}

// GetDeepSearchGraphBizType 获取深度搜索图名称
func (c *ZhiDaAgentLogicConfig) GetDeepSearchGraphBizType() string {
	return ""
}

// GetDefaultBizConfigMap 获取默认配置
func (c *ZhiDaAgentLogicConfig) GetDefaultBizConfigMap() map[string]map[string]string {
...
func (c *ZhiDaAgentLogicConfig) GetDynamicBizLogicConfig(
	ctx context.Context,
...
func (c *ZhiDaAgentLogicConfig) GetAbParamMap() map[zlab.SceneId][]zlab.ZlabValue {
