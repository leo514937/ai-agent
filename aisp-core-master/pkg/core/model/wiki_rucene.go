...
var WikiZhPath = "/rucene/ai/wiki"
var WikiZhIndex = "batch_wiki_202407251430"

var WikiEnPath = "/rucene/ai/wikienglish"
var WikiEnIndex = "batch_wikienglish_202408021120"

var WikiMapping = map[string]map[string]any{
	"content": {
		"type": "keyword",
	},
	"content_seg": {
...
var WikiSetting = map[string]any{
