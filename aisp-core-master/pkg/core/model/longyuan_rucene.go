...
var LongYuanPath = "/rucene/ai/longyuan"
var LongYuanIndex = "batch_longyuan_202407181555"

var LongYuanMapping = map[string]map[string]any{
	"content": {
		"type": "keyword",
	},
	"content_seg": {
...
var LongYuanSetting = map[string]any{
...
type LongYuanRucene struct {
	...
	DocId       int64       `json:"doc_id"`       // doc_id，为期刊的 section_id
